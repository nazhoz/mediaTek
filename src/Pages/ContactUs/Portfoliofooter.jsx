...
import './footer/pfooter.css'
import img3 from './footer/mail-inbox-app.png'
import img4 from './footer/arrow-right.png'
import img5 from './footer/facebook-app-symbol (1).png'
import img6 from './footer/facebook-app-symbol (2).png'
import img7 from './footer/vimeo.png'
import img8 from './footer/vimeo (1).png'
import img9 from './footer/twitter (1).png'
import img10 from './footer/twitter (2).png'
import img11 from './footer/linkedin.png'
import img12 from './footer/linkedin (1).png'
